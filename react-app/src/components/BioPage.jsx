...
const bioContent = [
  ...
  { type: 'body', text: 'Born in South Africa. Graudated at UT Austin. Building Continual Learning Infrastructure for AI Robotics in the Bay Area.' },
